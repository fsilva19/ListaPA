/*
    ...
    ◦ x for declarado como char? //incrementa 1 unidade
    => x+1 = 4093; x+2 = 4094; x+3 = 4095;

    ◦ x for declarado como int? //incrementa 2 unidades
    => x+1 = 4094; x+2 = 4096; x+3 = 4098;

    ◦ x for declarado como float? //incrementa 4 unidades
    => x+1 = 4096; x+2 = 4100; x+3 = 4104;

    ◦ x for declarado como double? //incrementa 8 unidades
